@testset "Test parsing a citable corpus into sentences" begin
        ...
        @test sents[1].urn == CtsUrn("urn:cts:latinLit:stoa1263.stoa001.hc_tokens:108a.1.1-108a.1.28a")
        @test sents[end].urn == CtsUrn("urn:cts:latinLit:stoa1263.stoa001.hc_tokens:108a.2.21-108a.2.32a")
end
...
@testset "Test parsing a SentenceAnnotation from delimited source" begin
        ...
        sa = nothing #GreekSyntax.sentence(src)
